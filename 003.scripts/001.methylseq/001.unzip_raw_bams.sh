...
# Unzip raw data
# Plate 144
unzip -q -n $RAW/CDN24ANXX_2_M8584.zip -d $DATA
unzip -q -n $RAW/CDN24ANXX_3_M8585.zip -d $DATA
unzip -q -n $RAW/CDN24ANXX_4_M8587.zip -d $DATA
unzip -q -n $RAW/CDN24ANXX_5_M8588.zip -d $DATA
mkdir -p $DATA/144
mv $DATA/CDN24ANXX*/* $DATA/144
rm -r $DATA/CDN24ANXX*
# Plate 145
unzip -q -n $RAW/CDN2BANXX_1_M8246.zip -d $DATA
unzip -q -n $RAW/CDN2BANXX_4.zip -d $DATA
unzip -q -n $RAW/CDN2BANXX_5.zip -d $DATA
unzip -q -n $RAW/CDN2BANXX_6.zip -d $DATA
mkdir -p $DATA/145
