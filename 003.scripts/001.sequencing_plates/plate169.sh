# Tom Ellis, May 2021
# Commands to process bisulphite data for plate 169
...
DIR=/scratch-cbe/users/thomas.ellis/plate_169
WORK=$DIR/000.work
OUT=/groups/nordborg/projects/epiclines/001.common_gardens/001.data/002.processed/plate_169
...
# Unzip raw data
zipfile=/groups/nordborg/projects/nordborg_rawdata/Athaliana/bisulfite_seq/field_data_from_2012/Tjpak3IDx6-HMYF5DRXX_20200928B_demux_2_R10191.zip
unzip $zipfile -d $DIR
# Run the pipeline
nextflow run ~/methylseq/main.nf \
-profile cbe,singularity \
--reads "${DIR}/HMYF5DRXX_20200928B_demux_2_R10191/*.bam" \
--fasta $ref_genome \
--outdir $MSEQ \
--aligner bwameth \
