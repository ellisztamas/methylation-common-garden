...
DIR=/scratch-cbe/users/thomas.ellis/plate_167
WORK=$DIR/000.work
OUT=/groups/nordborg/projects/epiclines/001.common_gardens/001.data/002.processed/plate_167
...
# Unzip raw data
zipfile=/groups/nordborg/projects/nordborg_rawdata/Athaliana/bisulfite_seq/field_data_from_2012/elxRjzjh9h-HKKWJDRXX_20200415B_demux_2_R9456.zip
unzip $zipfile -d $DIR
# Run the pipeline
nextflow run ~/methylseq/main.nf \
-profile cbe,singularity \
--reads "${DIR}/HKKWJDRXX_20200415B_demux_2_R9456/*.bam" \
--fasta $ref_genome \
--outdir $MSEQ \
--aligner bwameth \
